...
echo "Le souvenir de cette scène pour moi est comme une image de film figée à jamais à ce moment : le tapis rouge, la pelouse verte, la maison blanche, le ciel de plomb. Le nouveau président black et sa première dame. - Richard M. Nixon";

## Exo 2

$color = array('blanche', 'vert', 'rouge');

"Ecris un script PHP qui affichera les couleurs de la manière suivante :
